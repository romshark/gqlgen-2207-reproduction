...
type ComplexityRoot struct {
	Query struct {
		E func(childComplexity int, e1 model.E1, e2 model.E2, e3 model.E3) int
	}
}

type QueryResolver interface {
	E(ctx context.Context, e1 model.E1, e2 model.E2, e3 model.E3) (bool, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.e":
		...
		args, err := ec.field_Query_e_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.E(childComplexity, args["e1"].(model.E1), args["e2"].(model.E2), args["e3"].(model.E3)), true
...
func (ec *executionContext) field_Query_e_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 model.E1
...
func (ec *executionContext) _Query_e(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Query().E(rctx, fc.Args["e1"].(model.E1), fc.Args["e2"].(model.E2), fc.Args["e3"].(model.E3))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_e(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_e_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
